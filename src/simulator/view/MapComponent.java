...
public class MapComponent extends JPanel implements TrafficSimObserver {
	...
	public void paintComponent(Graphics graphics) {//se llama en repaint de trafficsimobserver
	...
	private void drawRoads(Graphics g) {
		for (Road r : _map.getRoads()) {
			...
			if (idx != -1 && r.equals(r.getDestination().getListaCarreterasEntrantes().get(idx))) {
